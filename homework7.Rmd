...
CreatorName <- {
  str_extract(painting[[wherePaintingName]][[1]][[2]]$Creator,"(?<=作者：)[\u4E00-\u9FFF]+")
}

Dynasty <- {
str_extract(painting[[wherePaintingName]][[1]][[2]]$Title,"(?<=主要題名：)[\u4E00-\u9FFF]+(?=CreatorName)")
}

}
get_painting_dynasty("主要題名：五代後蜀滕昌祐蝶戲長春圖　卷")
