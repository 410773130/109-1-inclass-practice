...
```{r ans13}
# G5TimeParsed
G5TimeParsed <- mdy_hm(paste0(NBA1920Final567$Game5[[1]]," 2020 ",NBA1920Final567$Game5[[2]]),tz="America/New_York")
print(G5TimeParsed)
```
...
```{r ans15}
# ParisLouis
with_tz(TpeJason,tzone = "Europe/Paris") + 15*60 -> ParisLouis
print(ParisLouis)
```
