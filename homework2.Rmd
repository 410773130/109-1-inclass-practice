...
# newPromotion1 
newPromotion1 <- list(
  category=factor("新登場",levels = c("新登場","推薦套餐","豪華雙響丼","牛丼類","咖哩類","豬肉丼類")),
  item="番茄牛丼",
...
# recommend1
recommend1 <- list(
  category=factor("推薦套餐",levels = c("新登場","推薦套餐","豪華雙響丼","牛丼類","咖哩類","豬肉丼類")),
  item="蔥溫玉牛丼套餐",
...
```{r ans14}
# sukiyaMenu2
sukiyaMenu[[1]][[1]] <- factor("牛丼類",levels = c("新登場","推薦套餐","豪華雙響丼","牛丼類","咖哩類","豬肉丼類"))
sukiyaMenu[[1]][[4]] <- 120
...
# sukiyaMenu3
sukiyaMenu3 <- list(
  category=list(sukiyaMenu[[1]]$category,sukiyaMenu[[2]]$category),
...
sukiyaMenu4 <-list(
  list(
    ...
    options=list(
      item=c(sukiyaMenu[[1]]$item),
      description=c(sukiyaMenu[[1]]$description),
      price=c(sukiyaMenu[[1]]$price)
    )
      ),
  list(
    category=as.character(sukiyaMenu[[2]]$category),
    options=list(
      item=c(sukiyaMenu[[2]]$item),
      description=c(sukiyaMenu[[2]]$description),
      price=c(sukiyaMenu[[2]]$price)
  )
))
