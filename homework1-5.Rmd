...
```{r ans12}
# Game5Time
Game5Time <- c(NBA1920Final567$Game5$Date,NBA1920Final567$Game5$StartTime,NBA1920Final567$Game5$TimeZone)
print(Game5Time)
```
...
# G5TimeParsed
G5TimeParsed <-
  mdy_hm(paste0(Game5Time[[1]], " 2020 " ,Game5Time[[2]]), tz="America/New_York")
print(G5TimeParsed)
...
```{r ans15}
# ParisLouis
ParisLouis <- with_tz(TpeJason,tzone = "Europe/Paris") + minutes(15)
print(ParisLouis)
```
